  ...
  return (
    <>
        <div className="bg-[url('/bg.avif')] bg-cover bg-fixed text-center lg:px-48 px-4 lg:py-40 py-28 text-white rounded-b-[30%]">
            ...
            <h1 className=' lg:text-6xl  text-3xl lg:font-extrabold font-bold mt-2'>Prepare yourself for the Next Generation of Internet with <span className='text-red-600'>Panaverse</span></h1>
            <p className=' lg:text-xl text-md mt-6 lg:px-[160px]'>One Year Panaverse DAO Earn as you Learn Program. Consolidating Web 3.0, Metaverse, Artificial Intelligence (AI), Cloud, Edge, and Ambient Computing/IoT Technologies</p>
        ...
        <div className=' flex flex-col md:flex-row w-[80%] items-center justify-around md:px-0 px-[80px] space-y-[50px] md:mt-[-90px] mt-[-50px] rounded-3xl m-auto shadow-2xl py-[50px] bg-white' >
            <Image src='/Logo.webp' alt='panaverse' height={140} width={140} />
            <Image src='/panacloud.svg' alt='panacloud' height={140} width={140} />
            <Image src='/PIAIC.svg' alt='piaic' height={80} width={80} />
            <Image src='/saylaniLogo.webp' alt='saylani' height={140} width={200} />
        </div>
        <div className=' lg:flex m-auto my-8 w-[80%] mt-24'>
            <div className=' lg:w-1/2 animate-pulse'>
                <Image alt='' src='/program.webp' height={400} width={400}/>
            </div>
            <div className=' lg:w-1/2 pt-10'>
                <h1 className=' md:text-5xl text-3xl font-serif md:font-bold font-semibold'>Program Of Studies</h1>
                <p className=' text-md mt-4 text-justify'>This curriculum is intended for beginners who want to learn software development from the ground up. It is going to be a fifteen-month-long hybrid program that includes both onsite and online classes and is divided into five quarters of 13 weeks each. The emphasis will be on hands-on learning by educating students to produce projects.</p>
        ...
        <div className=' w-[80%] justify-around  m-auto mt-12'>
            ...
            <div className='  md:grid mt-14 gap-8 pb-5 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5'>
                <div className=' bg-white rounded-2xl shadow-2xl pt-5'>
                    <div className="bg-[url('/zia.jpg')] bg-cover rounded-full  md:h-[150px] md:w-[150px] h-[100px] w-[100px] m-auto">
                ...
                <div className=' bg-white  rounded-2xl shadow-2xl  pt-5 md:mt-0 mt-6'>
                    <div className="bg-[url('/danial.jfif')] bg-cover rounded-full md:h-[150px] md:w-[150px] h-[100px] w-[100px] m-auto">
                ...
                <div className=' bg-white  rounded-2xl shadow-2xl  pt-5 md:mt-0 mt-6'>
                    <div className="bg-[url('/hira.jpg')] bg-cover rounded-full md:h-[150px] md:w-[150px] h-[100px] w-[100px] m-auto">
                ...
                <div className=' bg-white  rounded-2xl shadow-2xl pt-5 md:mt-0 mt-6'>
                    <div className="bg-[url('/adil.jfif')] bg-cover rounded-full md:h-[150px] md:w-[150px] h-[100px] w-[100px] m-auto">
                ...
                <div className=' bg-white  rounded-2xl shadow-2xl pt-5 md:mt-0 mt-6'>
                    <div className="bg-[url('/zeeshan.jfif')] bg-cover rounded-full md:h-[150px] md:w-[150px] h-[100px] w-[100px] m-auto">
        ...
        <div className=' flex justify-center mb-[30px]'>
            <div className="text-white rounded-3xl w-[80%] block lg:px-[100px] md:px-[80px] px-[20px] lg:py-[120px] py-[30px] text-center space-y-[20px] bg-gradient-to-br from-[#2a4ce5] via-[#9651cf] to-[#3FCBFF]">
                ...
                <p className=' text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt officiis, labore perferendis eius eos recusandae voluptatum suscipit at, blanditiis numquam veniam fugiat voluptatem delectus. Nesciunt officiis, labore perferendis eius eos recusandae voluptatum suscipit at, blanditiis numquam veniam fugiat voluptatem delectus. Velit fugiat ipsum exercitationem officiis tempore illo reiciendis rem. Voucimus vitae officia voluptate labore est debitis minima.</p>
